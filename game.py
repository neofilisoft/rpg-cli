...
def load_data():
    ...
    monsters = {
        "goblin": {
            ...
            "min_dmg": 1,
            "max_dmg": 6,
            "description": "มอนสเตอร์ตัวเล็กตะกละตาแดง",
            "gore_texts": {
                "crit_hit": [
                    "คุณฟันคอของกอบลินขาดลอย! หัวมันกระเด็นไปกระแทกผนังพร้อมเสียงกระแทกเปียก",
                    "คุณแทงดาบทะลุท้องกอบลินแล้วฉีกขึ้นมาจนถึงคาง ไส้และเลือดทะลักท่วมพื้น",
                    "คุณฟาดศอกกลางหน้า กอบลิน กะโหลกแตกเสียงดังกรอบ หนังตาข้างซ้ายหลุดจากเบ้า"
                ],
                "crit_fail": [
                    "ดาบของคุณพลาดและเสียบลงพื้นจนด้ามหัก เศษไม้ทิ่มฝ่ามือคุณเลือดไหล",
                    "คุณสะดุดกองอึกอบลินล้มหน้าคว่ำ กลิ่นเหม็นสาปเข้าจมูก",
                    "กอบลินหลบได้ คุณโจมตีพลาดและหกล้มก้นกระแทกพื้นจนกระดูกก้นกบร้าว"
                ]
            }
        },
        "orc": {
            ...
            "gore_texts": {
                "crit_hit": [
                    ...
                    "คุณใช้ขวานผ่าหัวออร์คจากมงกุฎจนถึงคาง สมองสีเทาแตกกระจาย"
                ],
                "crit_fail": [
        ...
        "necrophile": {
            ...
            "min_dmg": 3,
            "max_dmg": 10,
            "description": "ร่างสลายที่ยังเคลื่อนไหวได้ เนื้อเปื่อยและมีหนอนไต่ออก",
            "gore_texts": {
                "crit_hit": [
                    "คุณฟันร่างเนโครฟายล์เป็นสองท่อน หนอนนับร้อยร่วงหล่นดิ้นไปทั่ว",
                    "คุณเผาร่างเนโครฟายล์ด้วยไฟ กลิ่นเนื้อคนไหม้ปนน้ำเหลืองโชยเข้าจมูก",
                    "คุณทุบหัวเนโครฟายล์จนกะโหลกแบน สมองเน่าสีเขียวพุ่งออกทางรูตา"
                ],
                "crit_fail": [
                    "เนโครฟายล์อ้วกน้ำเหลืองใส่คุณ คุณสำลักและอาเจียนตาม",
                    "คุณเหยียบซากเน่าลื่นล้ม ตะปูสนิมทิ่มทะลุขาพลาสติก",
                    "เนโครฟายล์ฉีกเสื้อคุณและเลียหน้าอก คุณสะท้อนจนตัวแข็งไม่ขยับ"
                ]
            }
        },
        "succubus": {
            ...
            "nsfw_texts": {
                "crit_hit": [
                    ...
                    "คุณตัดปีกซักคิวบัส มันร้องครวญครางแบบสุดท้ายที่ฟังแล้วเข่าอ่อน"
                ],
                "crit_fail": [
                ...
                "special": [
                    "ซักคิวบัสถูอวัยวะคุณผ่านกางเกง 'น่าอนาถ...เล็กกว่าที่คิดนะ'",
...
class Character:
    ...
    def show_stats(self):
        ...
        print(f"โจมตีพื้นฐาน: {self.base_damage}")
...
def create_character():
    ...
    classes = [
        ...
        ("mage", "นักเวท - โจมตีเวทีสูง, HP ต่ำ"),
...
def combat_turn(player, monster, monster_data):
    ...
    if choice == "1":  # โจมตีพื้นฐาน
        ...
        skills = {
            "warrior": ("ฟันประจัญบาน", "โจมตีแรงเป็นสองเท่า แต่เสี่ยงพลาดสูง", 2, 15),
            "rogue": ("แทงข้างหลัง", "โจมตีเพิ่มความเสียหายหากศัตรูเผลอ", 1.5, 12),
            "mage": ("ไฟเบิล", "ลูกไฟทำความเสียหายเวที", 3, 10),
            "necromancer": ("ดูดชีวิต", "ดูด HP ศัตรูมาหนุนตัวเอง", 1, 8)
        }
        ...
        if player.inventory:
            ...
            item_choice = input("เลือกไอเทมที่จะใช้ (หรือกด Enter เพื่อยกเลิก): ")
            if item_choice:
...
def main():
    """ฟังก์ชันหลักของเกม"""
    clear_screen()
    print(f"{Colors.BOLD}{Colors.PURPLE}=== CLI DUNGEONS - NSFW/GORE EDITION ==={Colors.END}")
    print("เกมนี้มีเนื้อหารุนแรงทางเพศและความรุนแรง")
    ...
    while game_active and player.hp > 0:
        ...
        if choice == "1":  # สำรวจดันเจี้ยน
            ...
            if encounter_roll <= 15:  # เผชิญหน้ามอนสเตอร์
                ...
                print(f"\n{Colors.RED}⚠️  เผชิญหน้ากับ {monster_instance['name']}! {Colors.END}")
            ...
            if heal_amount > 0:
                ...
                if roll_dice(20) == 1:
                    print(f"\n{Colors.RED}⚠️  คุณถูกโจมตีขณะนอนหลับ! ⚠️{Colors.END}")
